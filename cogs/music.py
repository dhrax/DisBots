...
class Music(commands.Cog):
    ...
    @commands.command(name='playQueue', help='Starts playing the songs form the queue')
    ...
    @commands.command(name='showQueue', help='Shows the sogs queued of the current guid')
